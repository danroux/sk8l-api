...
var file_sk8l_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x07, 0x63, 0x72, 0x6f, 0x6e, 0x6a, 0x6f, 0x62, 0x32, 0xfa,
	0x02, 0x0a, 0x07, 0x43, 0x72, 0x6f, 0x6e, 0x6a, 0x6f, 0x62, 0x12, 0x3c, 0x0a, 0x0b, 0x47, 0x65,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x43,
	...
	0x6e, 0x73, 0x65, 0x12, 0x45, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x43, 0x72, 0x6f, 0x6e, 0x6a, 0x6f,
	0x62, 0x50, 0x6f, 0x64, 0x73, 0x12, 0x18, 0x2e, 0x73, 0x6b, 0x38, 0x6c, 0x2e, 0x43, 0x72, 0x6f,
	0x6e, 0x6a, 0x6f, 0x62, 0x50, 0x6f, 0x64, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x19, 0x2e, 0x73, 0x6b, 0x38, 0x6c, 0x2e, 0x43, 0x72, 0x6f, 0x6e, 0x6a, 0x6f, 0x62, 0x50, 0x6f,
	0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x41, 0x0a, 0x0e, 0x47, 0x65,
	...
	0x41, 0x4d, 0x4c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_sk8l_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_sk8l_proto_goTypes = []interface{}{
	...
	nil,                                  // 17: sk8l.CronjobResponse.ContainerCommandsEntry
	(*v1.ObjectMeta)(nil),                // 18: k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta
	(*v11.JobSpec)(nil),                  // 19: k8s.io.api.batch.v1.JobSpec
	(*v11.JobStatus)(nil),                // 20: k8s.io.api.batch.v1.JobStatus
	(*JobStatus)(nil),                    // 21: sk8l_custom.JobStatus
	(*v11.JobCondition)(nil),             // 22: k8s.io.api.batch.v1.JobCondition
	(*v12.PodSpec)(nil),                  // 23: k8s.io.api.core.v1.PodSpec
	(*v12.PodStatus)(nil),                // 24: k8s.io.api.core.v1.PodStatus
	(*v12.ContainerStatus)(nil),          // 25: k8s.io.api.core.v1.ContainerStatus
	(*v12.PodCondition)(nil),             // 26: k8s.io.api.core.v1.PodCondition
	(*v12.ContainerStateTerminated)(nil), // 27: k8s.io.api.core.v1.ContainerStateTerminated
	(*v11.CronJobSpec)(nil),              // 28: k8s.io.api.batch.v1.CronJobSpec
}
var file_sk8l_proto_depIdxs = []int32{
	...
	18, // 3: sk8l.JobResponse.metadata:type_name -> k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta
	19, // 4: sk8l.JobResponse.spec:type_name -> k8s.io.api.batch.v1.JobSpec
	20, // 5: sk8l.JobResponse.jobStatus:type_name -> k8s.io.api.batch.v1.JobStatus
	21, // 6: sk8l.JobResponse.status:type_name -> sk8l_custom.JobStatus
	22, // 7: sk8l.JobResponse.failureCondition:type_name -> k8s.io.api.batch.v1.JobCondition
	...
	18, // 10: sk8l.PodResponse.metadata:type_name -> k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta
	23, // 11: sk8l.PodResponse.spec:type_name -> k8s.io.api.core.v1.PodSpec
	24, // 12: sk8l.PodResponse.status:type_name -> k8s.io.api.core.v1.PodStatus
	...
	25, // 16: sk8l.ContainerResponse.status:type_name -> k8s.io.api.core.v1.ContainerStatus
	26, // 17: sk8l.ContainerResponse.conditions:type_name -> k8s.io.api.core.v1.PodCondition
	13, // 18: sk8l.ContainerResponse.terminatedReason:type_name -> sk8l.TerminationReason
	27, // 19: sk8l.TerminationReason.terminationDetails:type_name -> k8s.io.api.core.v1.ContainerStateTerminated
	...
	17, // 24: sk8l.CronjobResponse.containerCommands:type_name -> sk8l.CronjobResponse.ContainerCommandsEntry
	...
	28, // 29: sk8l.CronjobResponse.spec:type_name -> k8s.io.api.batch.v1.CronJobSpec
	...
	11, // 32: sk8l.CronjobResponse.ContainerCommandsEntry.value:type_name -> sk8l.ContainerCommands
	0,  // 33: sk8l.Cronjob.GetCronjobs:input_type -> sk8l.CronjobsRequest
	1,  // 34: sk8l.Cronjob.GetCronjob:input_type -> sk8l.CronjobRequest
	2,  // 35: sk8l.Cronjob.GetCronjobPods:input_type -> sk8l.CronjobPodsRequest
	1,  // 36: sk8l.Cronjob.GetCronjobYAML:input_type -> sk8l.CronjobRequest
	3,  // 37: sk8l.Cronjob.GetJobYAML:input_type -> sk8l.JobRequest
	4,  // 38: sk8l.Cronjob.GetPodYAML:input_type -> sk8l.PodRequest
	5,  // 39: sk8l.Cronjob.GetCronjobs:output_type -> sk8l.CronjobsResponse
	15, // 40: sk8l.Cronjob.GetCronjob:output_type -> sk8l.CronjobResponse
	16, // 41: sk8l.Cronjob.GetCronjobPods:output_type -> sk8l.CronjobPodsResponse
	7,  // 42: sk8l.Cronjob.GetCronjobYAML:output_type -> sk8l.CronjobYAMLResponse
	8,  // 43: sk8l.Cronjob.GetJobYAML:output_type -> sk8l.JobYAMLResponse
	9,  // 44: sk8l.Cronjob.GetPodYAML:output_type -> sk8l.PodYAMLResponse
